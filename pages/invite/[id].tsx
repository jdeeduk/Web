  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={inviteData.albumImagePreviewURL ?? "https://www.echophotos.io/images/AppIcon300.png"} />
        <meta property="og:title" content={inviteData.albumName ?? "Join Album"} />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Echo Photos" />
        <meta property="og:description" content="This link allows you to join an Echo Photos album." />
      </Head>
        ...
        <div className="container">
          <div id="inviteInfo" className="row">
            ...
            <div className="col-md-6 align-self-center text-center text-md-left">
              <div className="block">
                <h4 className="font-weight-bold mb-4 font-size-55" id="title">Album Invite Code</h4>
                <p style={{ textAlign: 'center', paddingTop: '20px', paddingRight: '20px', paddingBottom: '20px', paddingLeft: '20px', backgroundColor: 'lightgray', borderRadius: '25px', textTransform: 'uppercase', fontWeight: 'light', fontSize: '50px', fontFamily: "'Courier New', ui-monospace" }}
                  id="inviteCode">{inviteCode}</p>
                <p className="mb-4">Join the album by <b>entering the code</b> in the Echo Photos app. You can also <b>scan
                  the QR code with your phone</b> if you have the app installed.</p>
                <button className="btn btn-main btn-main-sm" onClick={() => copyToClipboard()}>Copy Code</button>
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-6 align-self-center text-center text-md-left">
              <div className="block">
                <h1 className="font-weight-bold mb-4 font-size-55" id="title">Get Echo Photos</h1>
                <p className="mb-4">The invite link you are trying to open can be opened with the Echo Photos App.
                </p>
